   ...
   <div class="asideLeft__user__messaggess">
      ...
      <div class="asideLeft__user__messaggess__body">
         <div class="asideLeft__user__messaggess__body__messagge">
            <div style="background-color: green;" class="asideLeft__user__messaggess__body__messagge__icon">
               <img src="assets/users/image.png" alt="">
            </div>
            <div class="asideLeft__user__messaggess__body__messagge__name">Murad Agamedov</div>
         </div>
      </div>
      <div class="asideLeft__user__messaggess__body">
         <div class="asideLeft__user__messaggess__body__messagge">
